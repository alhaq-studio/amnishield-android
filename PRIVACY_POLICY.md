...
Welcome to AmniShield ("we," "our," "us"). We are committed to protecting your privacy and providing a transparent understanding of how we handle your data. AmniShield is designed with a "privacy-first" approach. Our core mission is to help you build healthier digital habits, and that includes respecting your personal information.

This Privacy Policy explains what information we collect, how we use it, and your choices regarding your information. The fundamental principle of AmniShield is that **all sensitive data processing happens entirely on your device.** We do not have servers that collect your personal activity data.

## 2. Information We Collect

To provide our features, AmniShield collects information in the following ways:
...
This is the most sensitive category of data, and we want to be exceptionally clear about it. To perform its functions, AmniShield uses Android's Accessibility Services and other permissions. This data is **processed exclusively on your device** and is **never transmitted to our servers or any third party.**
...
We require certain permissions to provide the features of AmniShield. Here is a detailed explanation of why we need each of the key permissions:

* **Accessibility Service:** This is the core permission that allows AmniShield to function. We use it to:
...
We use the information we collect solely to provide and improve the functionality of the AmniShield app.
...
AmniShield is designed to minimize data sharing. We do not share your personal information, except in the limited circumstances described below:
...
All your personal configuration and usage data is stored locally on your device's internal storage. This data is retained as long as you have the AmniShield app installed.

You have full control over your data. You can delete your data in two ways:

1. **Clearing App Data:** You can go to your device's Settings -> Apps -> AmniShield -> Storage and tap "Clear Data." This will permanently delete all data associated with the app.
2. **Uninstalling the App:** Uninstalling the AmniShield application will remove the app and all of its associated data from your device.
...
* **Disable Permissions:** You can disable the Accessibility Service or other permissions for AmniShield at any time through your device's settings. Please note that doing so will cause the core features of the app to stop working.
...
AmniShield is not intended for use by children under the age of 13 (or the relevant age in your jurisdiction). We do not knowingly collect personal information from children.
