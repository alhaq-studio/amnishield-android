...
import com.alhaq.amnishield.databinding.ActivityAntiUninstallPasswordBinding
 ...
 * or uninstall/deactivate AmniShield.
...
class AntiUninstallPasswordActivity : AppCompatActivity() {
    ...
    private fun sendPasswordVerifiedBroadcast() {
        val intent = Intent(
            AmniShieldAccessibilityService.INTENT_ACTION_PASSWORD_VERIFIED
        ).setPackage(packageName)
