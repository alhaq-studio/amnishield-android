...
import com.alhaq.amnishield.databinding.DialogTweakBlockerWarningBinding
import com.alhaq.amnishield.services.AmniShieldAccessibilityService
import com.alhaq.amnishield.ui.activity.MainActivity
import com.alhaq.amnishield.utils.AnimTools.Companion.animateVisibility
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        return MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(getString(R.string.save)) { dialog, _ ->
                ...
                sendRefreshRequest(AmniShieldAccessibilityService.INTENT_ACTION_REFRESH_REEL_BLOCKER)
                dialog.dismiss()
            }
