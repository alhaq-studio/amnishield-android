...
class ScreentimeWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        ...
        private const val ACTION_WIDGET_REFRESH = ".amnishield.screentime.WIDGET_REFRESH"
    }
    ...
    private fun updateWidget(
        ...
        val totalScreentime = com.alhaq.amnishield.utils.ScreenTimeCalculator.getTodayScreenTime(context)
        try{
