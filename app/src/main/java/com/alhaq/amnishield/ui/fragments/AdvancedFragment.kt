...
import com.alhaq.amnishield.ui.screens.AdvancedScreen
...
class AdvancedFragment : BaseFeatureFragment() {
            ...
            setContent {
                ...
                AmniShieldTheme(appTheme = activeTheme) {
                    AdvancedScreen(
                        ...
                        onNavigateToRoadmap = { openFeatureConfig("roadmap", requiresPremium = false) },
                        onNavigateToSupport = { (activity as? MainActivity)?.showSupportOptionsDialog() },
    ...
    private fun togglePinSecurity(enabled: Boolean, pin: String) {
        ...
        if (!enabled) {
            ...
            com.alhaq.amnishield.AmniShield.lockSession()
        } else {
