package com.alhaq.amnishield.ui.fragments.anti_uninstall
...
import com.alhaq.amnishield.databinding.FragmentChoseAntiUninstallModeBinding
...
class ChooseModeFragment : Fragment() {
    ...
    private fun verifyPinIfNeeded(onSuccess: () -> Unit) {
        ...
        val composeView = ComposeView(requireContext()).apply {
            ...
            setContent {
                AmniShieldTheme(appTheme = ThemeUtils.resolveAppTheme(requireContext())) {
