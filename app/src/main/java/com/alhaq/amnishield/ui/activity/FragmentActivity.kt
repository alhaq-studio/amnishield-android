...
import com.alhaq.amnishield.ui.fragments.anti_uninstall.ChooseModeFragment
...
import com.alhaq.amnishield.ui.fragments.installation.PermissionsFragment
import com.alhaq.amnishield.ui.fragments.features.PremiumFeaturesFragment
import com.alhaq.amnishield.ui.fragments.usage.AllAppsUsageFragment
import com.alhaq.amnishield.ui.fragments.BlocksManagerFragment
import com.alhaq.amnishield.ui.fragments.ManageLaunchLimitsFragment
import com.alhaq.amnishield.ui.fragments.ProfileFragment
...
class FragmentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (featureType != null) {
            fragment = when (featureType) {
                "focus_mode" -> com.alhaq.amnishield.ui.fragments.FocusFragment()
                "focus_mode_config" -> com.alhaq.amnishield.ui.fragments.features.FocusModeConfigFragment()
                "app_blocker" -> com.alhaq.amnishield.ui.fragments.features.AppBlockerConfigFragment()
                "app_blocker_schedules" -> com.alhaq.amnishield.ui.fragments.BlocksManagerFragment().apply {
                ...
                "reel_blocker" -> com.alhaq.amnishield.ui.fragments.features.ReelBlockerConfigFragment()
                "reels_metrics" -> com.alhaq.amnishield.ui.fragments.usage.ReelsMetricsFragment()
                "website_blocker", "social_media_blocker" -> com.alhaq.amnishield.ui.fragments.features.WebsiteBlockerConfigFragment()
                "usage_tracker" -> com.alhaq.amnishield.ui.fragments.features.UsageTrackerConfigFragment()
                "keyword_blocker" -> com.alhaq.amnishield.ui.fragments.features.KeywordBlockerConfigFragment()
                "anti_uninstall" -> ChooseModeFragment()
                "setup_password_mode" -> com.alhaq.amnishield.ui.fragments.anti_uninstall.SetupPasswordModeFragment()
                "setup_timed_mode" -> com.alhaq.amnishield.ui.fragments.anti_uninstall.SetupTimedModeFragment()
        ...
        if (fragment == null && intent.getStringExtra("fragment") != null) {
            when (intent.getStringExtra("fragment")) {
                com.alhaq.amnishield.ui.fragments.features.FocusModeConfigFragment.FRAGMENT_ID -> {
                    fragment = com.alhaq.amnishield.ui.fragments.features.FocusModeConfigFragment()
                }
                ...
                com.alhaq.amnishield.ui.fragments.usage.ReelsMetricsFragment.FRAGMENT_ID -> {
                    fragment = com.alhaq.amnishield.ui.fragments.usage.ReelsMetricsFragment()
                }
                com.alhaq.amnishield.ui.fragments.features.AppBlockerConfigFragment.FRAGMENT_ID -> {
                    fragment = com.alhaq.amnishield.ui.fragments.features.AppBlockerConfigFragment()
                }
        ...
        if (fragment != null) {
            ...
            val needsPin = isBlockerConfig && pinEnabled && pinCode.isNotEmpty() && !AmniShield.isBypassSessionActive()
    ...
    private fun showBypassPinDialog(correctPinCode: String, onSuccess: () -> Unit) {
        ...
        val composeView = androidx.compose.ui.platform.ComposeView(this).apply {
            ...
            setContent {
                AmniShieldTheme(appTheme = com.alhaq.amnishield.utils.ThemeUtils.resolveAppTheme(this@FragmentActivity)) {
