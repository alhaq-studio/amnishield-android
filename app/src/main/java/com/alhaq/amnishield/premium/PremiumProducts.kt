...
object PremiumProducts {
    ...
    private const val LEGACY_PRODUCT_LIFETIME = "deenshield_premium_lifetime"
    private const val LEGACY_PRODUCT_MONTHLY = "deenshield_premium_monthly"
    private const val LEGACY_PRODUCT_YEARLY = "deenshield_premium_yearly"
